...
const buffer_1 = require("../../src.ts/utils/buffer");
...
async function createProtomessageFixture({ protocolTag, protomessagePointer, protomessageRefundPointer, }) {
    ...
    const calldata = (0, buffer_1.bufferToU128Array)(Buffer.from("testing 12345"));
    ...
    ], block, 2 // leftover protorunes go to output2, which is ADDRESS 1
    );
 ...
 * @returns
 */
async function createMultipleProtomessageFixture({ protocolTag, protomessagePointer, protomessageRefundPointer, calldata, amount1, amount2, }) {
    let { block, output, refundOutput, runeId1, runeId2, pointerToReceiveRunes, premineAmount, } = 
    // this fixture always assumes a protoburn and default values
    await createMultipleProtoruneFixture(protocolTag);
    const edicts = [];
    if (amount1) {
        edicts.push({
            amount: (0, integer_1.u128)(amount1),
    ...
    if (amount2) {
        edicts.push({
            amount: (0, integer_1.u128)(amount2),
            id: new runeid_1.RuneId((0, integer_1.u64)(runeId2.block), (0, integer_1.u32)(runeId2.tx)),
            output: (0, integer_1.u32)(5),
        });
    }
