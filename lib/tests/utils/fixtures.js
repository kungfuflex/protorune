...
exports.TEST_PROTOCOL_TAG = void 0;
...
exports.TEST_PROTOCOL_TAG = BigInt("0x400000000000000000");
/**
 ...
 */
async function createProtoruneFixture(omitBurn = false, premineAmount = 2100000005000000n, { skip, } = {
    skip: 0,
}, _block) {
    const outputs = [
        {
    ...
    if (!omitBurn) {
        ...
        exports.TEST_PROTOCOL_TAG, block, 
...
async function createProtomessageFixture({ protomessagePointer, protomessageRefundPointer, }) {
    ...
    block = (0, protoburn_1.constructProtostoneTx)([
        ...
        protostone_1.ProtoStone.edicts({
            protocolTag: exports.TEST_PROTOCOL_TAG,
            edicts: [
                {
 ...
 */
async function createMultipleProtoruneFixture(omitBurn = false, premineAmount = 2100000005000000n, { skip, } = {
    skip: 0,
}, _block) {
    const outputs = [
        {
 ...
 * @returns
 */
async function createMultipleProtomessageFixture({ protomessagePointer, protomessageRefundPointer, }) {
