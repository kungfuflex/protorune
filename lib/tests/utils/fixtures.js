...
async function createProtoruneFixture(omitBurn = false, premineAmount = 2100000005000000n, TEST_PROTOCOL_TAG = BigInt("0x400000000000000000")) {
    // ================================
    ...
    const pointer1 = 1;
    let block = (0, rune_helpers_1.initCompleteBlockWithRuneEtching)(outputs, pointer1, undefined, premineAmount);
    const input = {
