...
class RuntimeInput$Type extends runtime_4.MessageType {
    constructor() {
        super("protorune.RuntimeInput", [
            { no: 1, name: "protocol_tag", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "rune", kind: "message", T: () => exports.RuneId }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.rune)
            exports.RuneId.internalBinaryWrite(message.rune, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Runtime$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        /* bytes balance = 1; */
        if (message.balance.length)
            writer.tag(1, runtime_1.WireType.LengthDelimited).bytes(message.balance);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
