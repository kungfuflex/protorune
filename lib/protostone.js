...
class ProtoStone {
    ...
    encipher_payloads() {
        ...
        const prefix = [toBuffer(payloads.reduce((r, v) => r || decodeList(v)[0] === 83n, false) ? (0, integer_1.u128)(13) : (0, integer_1.u128)(this.protocolTag)), toBuffer((0, integer_1.u128)(length_payload))];
