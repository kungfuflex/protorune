...
class ProtoStone {
    ...
    encipher_payloads() {
        ...
        payloads.unshift(integer_1.u128.encodeVarInt((0, integer_1.u128)(length_payload))),
            payloads.unshift(payloads.reduce((r, v) => r || decodeList(v)[0] === 83n, false) ? integer_1.u128.encodeVarInt((0, integer_1.u128)(13)) : integer_1.u128.encodeVarInt(this.protocolTag));
