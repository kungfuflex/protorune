 ...
 */
var Ul=Object.defineProperty;var Bc=Object.getOwnPropertyDescriptor;var a2=Object.getOwnPropertyNames;var l2=Object.prototype.hasOwnProperty;var Vl=(t,i)=>{for(var e in i)Ul(t,e,{get:i[e],enumerable:!0})},Pc=(t,i,e,r)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of a2(i))!l2.call(t,n)&&n!==e&&Ul(t,n,{get:()=>i[n],enumerable:!(r=Bc(i,n))||r.enumerable});return t},Dl=(t,i,e)=>(Pc(t,i,"default"),e&&Pc(e,i,"default"));var Nc=(t,i,e,r)=>{for(var n=r>1?void 0:r?Bc(i,e):i,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(r?a(i,e,n):a(n))||n);return r&&n&&Ul(i,e,n),n};var wc={};Vl(wc,{ASTBuilder:()=>Ac,ArrayLiteralExpression:()=>na,ArrowKind:()=>ci,AssertionExpression:()=>sa,AssertionKind:()=>ui,AtomicRMWOp:()=>gp,BinaryExpression:()=>aa,BinaryModule:()=>fl,BinaryOp:()=>hi,BlockStatement:()=>Na,BrOnOp:()=>By,BreakStatement:()=>La,CallExpression:()=>la,Class:()=>Kt,ClassDeclaration:()=>mn,ClassExpression:()=>oa,ClassPrototype:()=>Hn,CommaExpression:()=>ua,CommentKind:()=>pp,CommentNode:()=>ia,CommonFlags:()=>Ve,CommonNames:()=>P,CompiledExpression:()=>Pa,Compiler:()=>ds,ConditionKind:()=>Lp,ConstantValueKind:()=>Up,Constraints:()=>Sc,ConstructorExpression:()=>pa,ContinueStatement:()=>Ma,DEFAULT_STACK_SIZE:()=>qI,DeclarationStatement:()=>Oe,DeclaredElement:()=>Ht,DecoratorFlags:()=>jt,DecoratorKind:()=>Tt,DecoratorNode:()=>ra,DiagnosticCategory:()=>ea,DiagnosticCode:()=>st,DiagnosticEmitter:()=>De,DiagnosticMessage:()=>Js,DoStatement:()=>Ga,Element:()=>qn,ElementAccessExpression:()=>ca,ElementKind:()=>ut,EmptyStatement:()=>za,Enum:()=>kl,EnumDeclaration:()=>Ua,EnumValue:()=>Al,EnumValueDeclaration:()=>Va,ExportDefaultStatement:()=>Wa,ExportImportStatement:()=>Da,ExportMember:()=>qa,ExportNames:()=>fs,ExportStatement:()=>Oa,Expression:()=>de,ExpressionId:()=>yr,ExpressionRunnerFlags:()=>hl,ExpressionStatement:()=>Ka,ExternalKind:()=>yp,FEATURES_ALL:()=>a0,FEATURES_DEFAULT:()=>l0,FEATURE_BULK_MEMORY:()=>$I,FEATURE_EXCEPTION_HANDLING:()=>YI,FEATURE_EXTENDED_CONST:()=>n0,FEATURE_GC:()=>t0,FEATURE_MEMORY64:()=>r0,FEATURE_MULTI_VALUE:()=>e0,FEATURE_MUTABLE_GLOBALS:()=>HI,FEATURE_NONTRAPPING_F2I:()=>jI,FEATURE_REFERENCE_TYPES:()=>JI,FEATURE_RELAXED_SIMD:()=>i0,FEATURE_SIGN_EXTENSION:()=>KI,FEATURE_SIMD:()=>XI,FEATURE_STRINGREF:()=>s0,FEATURE_TAIL_CALLS:()=>QI,FEATURE_THREADS:()=>ZI,FalseExpression:()=>Aa,Feature:()=>Ut,FeatureFlags:()=>mp,FieldDeclaration:()=>Ha,FieldFlags:()=>Np,File:()=>Wn,FloatLiteralExpression:()=>_a,Flow:()=>St,FlowFlags:()=>xl,ForOfStatement:()=>$a,ForStatement:()=>ja,Function:()=>ct,FunctionDeclaration:()=>yn,FunctionExpression:()=>fa,FunctionPrototype:()=>He,FunctionTypeNode:()=>dr,GETTER_PREFIX:()=>Ds,Global:()=>br,HeapTypeRef:()=>ue,INDEX_SUFFIX:()=>Pe,INNER_DELIMITER:()=>Xu,INSTANCE_DELIMITER:()=>$u,IdentifierExpression:()=>qe,IdentifierHandling:()=>_p,IfStatement:()=>Xa,ImportDeclaration:()=>Za,ImportNames:()=>Bi,ImportStatement:()=>gn,IndexSignature:()=>Gn,IndexSignatureNode:()=>Ba,InstanceOfExpression:()=>ha,IntegerLiteralExpression:()=>da,Interface:()=>zn,InterfaceDeclaration:()=>Ya,InterfacePrototype:()=>wl,JSBuilder:()=>ki,LIBRARY_PREFIX:()=>nt,LIBRARY_SUBST:()=>Os,LiteralExpression:()=>at,LiteralKind:()=>Dt,Local:()=>Me,LocalFlags:()=>Nn,MemorySegment:()=>fi,MethodDeclaration:()=>mr,Module:()=>Ot,ModuleDeclaration:()=>nl,NamedTypeNode:()=>hr,Namespace:()=>Kn,NamespaceDeclaration:()=>Qa,NewExpression:()=>ma,Node:()=>L,NodeKind:()=>xt,NullExpression:()=>ya,ObjectLiteralExpression:()=>ga,OmittedExpression:()=>ba,OperatorKind:()=>Ge,Options:()=>hs,PARENT_SUBST:()=>d2,PATH_DELIMITER:()=>Ye,PackedType:()=>En,Parameter:()=>zp,ParameterKind:()=>oi,ParameterNode:()=>ai,ParenthesizedExpression:()=>xa,Parser:()=>Vn,Precedence:()=>Oy,Program:()=>Dn,Property:()=>Mn,PropertyAccessExpression:()=>Ta,PropertyPrototype:()=>Ti,Range:()=>le,RefAsOp:()=>Py,RegexpLiteralExpression:()=>Ea,Relooper:()=>_l,ReportMode:()=>Sl,Resolver:()=>Ln,ReturnStatement:()=>Ja,Runtime:()=>Us,RuntimeFeatures:()=>Ic,SETTER_PREFIX:()=>qs,SIMDExtractOp:()=>bp,SIMDLoadOp:()=>Ep,SIMDLoadStoreLaneOp:()=>vp,SIMDReplaceOp:()=>xp,SIMDShiftOp:()=>Tp,SIMDTernaryOp:()=>Sp,STATIC_DELIMITER:()=>on,STUB_DELIMITER:()=>Zu,SideEffects:()=>Bp,Signature:()=>ze,Source:()=>fe,SourceKind:()=>pi,State:()=>pl,Statement:()=>oe,StringAsOp:()=>zy,StringEncodeOp:()=>My,StringEqOp:()=>Gy,StringIterMoveOp:()=>Uy,StringLiteralExpression:()=>Sa,StringMeasureOp:()=>Ly,StringNewOp:()=>Ny,StringSliceWTFOp:()=>Vy,SuperExpression:()=>Ia,SwitchBuilder:()=>vn,SwitchCase:()=>el,SwitchStatement:()=>tl,TSDBuilder:()=>Ni,Target:()=>Zr,TemplateLiteralExpression:()=>Fa,TernaryExpression:()=>va,ThisExpression:()=>Ra,ThrowStatement:()=>rl,Token:()=>_i,Tokenizer:()=>xn,TrueExpression:()=>ka,TryStatement:()=>il,Type:()=>u,TypeBuilderErrorReason:()=>dp,TypeDeclaration:()=>sl,TypeDefinition:()=>Xe,TypeFlags:()=>pt,TypeKind:()=>Wt,TypeName:()=>si,TypeNode:()=>hn,TypeParameterNode:()=>ta,TypeRef:()=>B,TypedElement:()=>Ft,Typeinfo:()=>Yr,TypeinfoFlags:()=>Vs,UnaryExpression:()=>dn,UnaryOp:()=>Sn,UnaryPostfixExpression:()=>wa,UnaryPrefixExpression:()=>Ca,UncheckedBehavior:()=>Tl,VariableDeclaration:()=>al,VariableLikeDeclarationStatement:()=>li,VariableLikeElement:()=>xr,VariableStatement:()=>ll,VoidStatement:()=>ol,WhileStatement:()=>ul,addGlobalAlias:()=>MI,allocPtrArray:()=>_e,buildJS:()=>L0,buildTSD:()=>N0,compile:()=>B0,createType:()=>We,defaultFeatures:()=>Ml,diagnosticCategoryToColor:()=>ky,diagnosticCategoryToString:()=>up,diagnosticCodeToString:()=>Ws,ensureType:()=>Bn,expandType:()=>Ip,featureToString:()=>Xr,findDecorator:()=>Et,formatDiagnostic:()=>Ay,formatDiagnosticMessage:()=>Ay,getBinaryLeft:()=>Ke,getBinaryOp:()=>yi,getBinaryRight:()=>we,getBinaryenModuleRef:()=>M0,getBlockChildAt:()=>wn,getBlockChildCount:()=>An,getBlockName:()=>kn,getBreakCondition:()=>Z2,getBreakName:()=>X2,getCallOperandAt:()=>Le,getCallOperandCount:()=>ot,getCallTarget:()=>Pn,getConstValueF32:()=>ge,getConstValueF64:()=>be,getConstValueI32:()=>te,getConstValueI64High:()=>Ae,getConstValueI64Low:()=>Ee,getConstValueV128:()=>Fp,getDefaultParameterName:()=>jy,getDependee:()=>C0,getDiagnosticCategory:()=>g0,getDiagnosticCode:()=>y0,getDiagnosticMessage:()=>b0,getDiagnosticRange:()=>x0,getDiagnosticRelatedRange:()=>T0,getDropValue:()=>Q2,getExpressionId:()=>Q,getExpressionType:()=>ie,getFunctionBody:()=>tx,getFunctionName:()=>Cp,getFunctionParams:()=>rx,getFunctionResults:()=>ix,getFunctionVars:()=>nx,getGlobalGetName:()=>Fn,getGlobalInit:()=>lx,getGlobalName:()=>sx,getGlobalType:()=>ax,getIfCondition:()=>yl,getIfFalse:()=>gi,getIfTrue:()=>Cn,getLoadBytes:()=>Rp,getLoadOffset:()=>D2,getLoadPtr:()=>q2,getLocalGetIndex:()=>lt,getLocalSetIndex:()=>dl,getLocalSetValue:()=>gr,getLoopBody:()=>$2,getLoopName:()=>j2,getMemoryGrowDelta:()=>ex,getRangeEnd:()=>v0,getRangeSource:()=>S0,getRangeStart:()=>E0,getReturnValue:()=>J2,getSelectCondition:()=>Y2,getSelectElse:()=>wp,getSelectThen:()=>Ap,getSideEffects:()=>bi,getSource:()=>m0,getSourceNormalizedPath:()=>I0,getStoreBytes:()=>O2,getStoreOffset:()=>W2,getStorePtr:()=>K2,getStoreValue:()=>H2,getTagName:()=>ox,getTagParams:()=>ux,getTagResults:()=>px,getUnaryOp:()=>Rn,getUnaryValue:()=>ml,initializeProgram:()=>P0,isConstExpressionNaN:()=>mi,isConstNaN:()=>V2,isConstNegZero:()=>di,isConstNonZero:()=>et,isConstZero:()=>Ie,isDeclaredElement:()=>On,isError:()=>k0,isGlobalMutable:()=>Pp,isIllegalVariableIdentifier:()=>fp,isInfo:()=>F0,isLoadSigned:()=>kp,isLocalTee:()=>In,isNullableType:()=>Dy,isTypeOmitted:()=>Se,isTypedElement:()=>El,isWarning:()=>R0,mangleInternalName:()=>Ce,mangleInternalPath:()=>bn,mustPreserveSideEffects:()=>gl,newOptions:()=>TI,newProgram:()=>h0,nextDiagnostic:()=>d0,nextFile:()=>w0,operatorTokenToString:()=>Te,optimize:()=>z0,parse:()=>A0,readString:()=>Ne,removeGlobalAlias:()=>GI,runtimeFunctions:()=>Ai,runtimeGlobals:()=>wi,setBasenameHint:()=>p0,setBindingsHint:()=>c0,setBundleVersion:()=>WI,setDebugInfo:()=>f0,setExportMemory:()=>II,setExportRuntime:()=>DI,setExportStart:()=>zI,setExportTable:()=>CI,setFeature:()=>o0,setImportMemory:()=>FI,setImportTable:()=>wI,setInitialMemory:()=>RI,setLowMemoryLimit:()=>VI,setMaximumMemory:()=>kI,setMemoryBase:()=>NI,setNoAssert:()=>SI,setNoUnsafe:()=>UI,setOptimizeLevelHints:()=>u0,setPedantic:()=>_0,setRuntime:()=>vI,setSharedMemory:()=>AI,setSourceMap:()=>PI,setStackSize:()=>OI,setTableBase:()=>LI,setTarget:()=>EI,setUncheckedBehavior:()=>BI,tokenFromKeyword:()=>wy,tokenIsAlsoIdentifier:()=>Cy,typesToRefs:()=>Tr,typesToString:()=>vl,util:()=>op,validate:()=>G0});var Z=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof Z.ASC_TARGET>"u"){let e=function(){Error.captureStackTrace?Error.captureStackTrace(this,e):this.stack=this.name+": "+this.message+`
...
`),U(n,--this.indentLevel),n.push(`))({}),
`),this.visitNamespace(e,r)}makeGlobalImport(e,r,n){let s=this.sb,a=n.type;U(s,this.indentLevel),Be(r)?s.push(r):(s.push('"'),s.push(ye(r,34)),s.push('": '));let l=this.ensureModuleId(e);zr(a,0)?(s.push(`(
...
`),U(s,--this.indentLevel),s.push("}")),s.push(`,
`)}makeFunctionImport(e,r,n,s=null){let a=this.sb,l=n.signature;if(U(a,this.indentLevel),Be(r)?a.push(r):(a.push('"'),a.push(ye(r,34)),a.push('"')),kc(l,0)&&!s&&Be(r))a.push(`: (
...
`);let o=a.length;for(let S=Map_keys(r),T=0,v=S.length;T<v;++T){let F=S[T],I=this.ensureModuleId(F),R=r.get(F);if(U(a,this.indentLevel),Be(F)?a.push(F):(a.push('"'),a.push(ye(F,34)),a.push('"')),!xI(F)){a.push(": __module"),a.push(I.toString()),a.push(`,
...
`),++this.indentLevel;let N=0;for(let D=Map_keys(R),W=0,V=D.length;W<V;++W){let O=D[W],X=assert(R.get(O));if(X.kind==5){let re=X,Y=this.getExternalCode(re);(!kc(re.signature,0)||!Be(O)||Y)&&(this.makeFunctionImport(F,O,X,Y),++N)}else if(X.kind==0){let re=X;(!zr(re.type,0)||!Be(O))&&(this.makeGlobalImport(F,O,re),++N)}}--this.indentLevel,N?(U(a,this.indentLevel),a.push(`}),
...
`)):a.length=o-2;let c=this.importMappings,_=new Array;for(let S=Map_keys(c),T=0,v=S.length;T<v;++T){let F=S[T];if(F=="env")_.push(`  const env = imports.env;
...
`)),_.push("  const __module"),_.push(I.toString()),_.push(" = imports"),Be(F)?(_.push("."),_.push(F)):(_.push('["'),_.push(ye(F,34)),_.push('"]')),_.push(`;
...
`)}if(this.needsLiftString){let S=n.OBJECTInstance,T=S.offsetof("rtSize")-S.nextMemoryOffset,v=1024;a.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
    ...
    let
      start = pointer >>> 1,
      string = "";
    while (end - start > ${v}) string += String.fromCharCode(...memoryU16.subarray(start, start += ${v}));
...
`)}if(this.needsLowerArray){let S=n.arrayBufferInstance.id,T=n.arrayBufferViewInstance,v=T.nextMemoryOffset+4,F=T.offsetof("buffer"),I=T.offsetof("dataStart"),R=T.offsetof("byteLength"),C=R+4;this.needsSetU32=!0,a.push(`  function __lowerArray(lowerElement, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${S})) >>> 0,
      header = exports.__pin(exports.__new(${v}, id)) >>> 0;
...
`)}if(this.needsLiftTypedArray){let S=n.arrayBufferViewInstance,T=S.offsetof("dataStart"),v=S.offsetof("byteLength");this.needsGetU32=!0,a.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
    return new constructor(
      memory.buffer,
      __getU32(pointer + ${T}),
      __dataview.getUint32(pointer + ${v}, true) / constructor.BYTES_PER_ELEMENT
    ).slice();
  }
`)}if(this.needsLowerTypedArray){let S=n.arrayBufferInstance.id,T=n.arrayBufferViewInstance,v=T.nextMemoryOffset,F=T.offsetof("buffer"),I=T.offsetof("dataStart"),R=T.offsetof("byteLength");this.needsSetU32=!0,a.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${S})) >>> 0,
      header = exports.__new(${v}, id) >>> 0;
    __setU32(header + ${F}, buffer);
    __dataview.setUint32(header + ${I}, buffer, true);
    __dataview.setUint32(header + ${R}, length << align, true);
...
`),this.program.options.exportRuntime){for(let v=0,F=Ai.length;v<F;++v)a.push("  "),a.push(Ai[v]),a.push(`,
`);for(let v=0,F=wi.length;v<F;++v)a.push("  "),a.push(wi[v]),a.push(`,
`)}for(let v=0,F=e.length;v<F;++v)a.push("  "),a.push(e[v]),a.push(`,
`);a.push(`} = await (async url => instantiate(
  await (async () => {
    try { return await globalThis.WebAssembly.compileStreaming(globalThis.fetch(url)); }
    catch { return globalThis.WebAssembly.compile(await (await import("node:fs/promises")).readFile(url)); }
  })(), {
`);let S=!1,T=new Array;for(let v=Map_keys(c),F=0,I=v.length;F<I;++F){let R=v[F];if(R=="env")U(a,2),a.push(`env: globalThis,
`);else{let C=this.ensureModuleId(R);U(a,2),Be(R)?a.push(R):(a.push('"'),a.push(ye(R,34)),a.push('"')),a.push(": __maybeDefault(__import"),a.push(C.toString()),a.push(`),
...
`);let n=this.program.moduleImports;for(let s=Map_keys(n),a=0,l=s.length;a<l;++a){let o=s[a];e.push("  "),Be(o)?e.push(o):(e.push('"'),e.push(ye(o,34)),e.push('"')),e.push(`: unknown,
